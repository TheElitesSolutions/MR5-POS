...
import { Clock, MapPin, Eye, ShoppingBag, Calendar, User } from 'lucide-react';
const OrderCard = ({ order, onViewDetails, showActions = true, }) => {
    ...
    return (<Card className='group relative overflow-hidden transition-all duration-200 hover:shadow-lg hover:-translate-y-0.5'>
      <CardContent className='p-5'>
        ...
        <div className='mb-4 flex items-start justify-between'>
          <div>
            ...
            <div className='mt-1 flex items-center gap-2'>
              ...
              {order.customerName && (<span className='text-xs text-gray-500 dark:text-gray-400 flex items-center gap-1'>
        ...
        <div className='mb-3 space-y-2 text-xs'>
          ...
          <div className='flex items-center justify-between gap-2'>
            {/* Table */}
            {(order.tableId || order.tableName) && (<div className='flex items-center gap-1.5'>
        ...
        {/* Actions */}
        {showActions && (<Button variant='outline' size='sm' onClick={handleViewDetails} className='w-full mt-2 group-hover:bg-gray-50 dark:group-hover:bg-gray-800'>
