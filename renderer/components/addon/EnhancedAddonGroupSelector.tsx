...
interface EnhancedAddonGroupSelectorProps {
  group: AddonGroup;
  addons: Addon[];
 ...
 */
export const EnhancedAddonGroupSelector: React.FC<
  EnhancedAddonGroupSelectorProps
> = ({
  group,
  addons,
  selections,
  ...
  const { focusedAddonIndex, focusAddon, navigateWithinGroup } =
    useAddonGroupFocus(group.id, displayAddons.length);
...
export const MemoizedEnhancedAddonGroupSelector = React.memo(
