...
interface VirtualAddonListProps {
  addons: Addon[];
 ...
 */
export const VirtualAddonList: React.FC<VirtualAddonListProps> = ({
  addons,
  selections,
  stockLevels,
  onSelectionChange,
  onDeselect,
  itemHeight = 120, // Estimated height per addon
  ...
  return (
    <div className={cn('relative', className)}>
      ...
      <div
        ...
        role='list'
        aria-label={`Add-on list with ${addons.length} items`}
      >
        {/* Total height spacer */}
