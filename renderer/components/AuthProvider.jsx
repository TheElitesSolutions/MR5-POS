...
export const AuthProvider = ({ children, }) => {
    ...
    const { user, accessToken, refreshToken, clearAuth, refreshAccessToken, _hasHydrated // Track hydration status
     } = useAuthStore();
        ...
        const initialize = async () => {
            ...
            try {
                ...
                if (refreshToken) {
                    ...
                    console.log('AuthProvider: Token refresh disabled for desktop, keeping existing auth');
                    // NOTE: Token refresh disabled but keeping existing auth
    ...
    useEffect(() => {
        ...
        console.log('AuthProvider: Periodic token refresh disabled for desktop version');
    ...
    return (<AuthContext.Provider value={{ isAuthenticated, isLoading, checkAuth, logout }}>
      {children}
