...
import { Plus, FileText, BarChart3, RefreshCw, Settings, Download, Printer, Users, Package, } from 'lucide-react';
      ...
      <CardContent>
        <div className='grid grid-cols-2 gap-4 sm:grid-cols-4 lg:grid-cols-8'>
          {actions.map(action => {
            ...
            return (<Button key={action.id} variant='outline' className='flex h-auto flex-col items-center space-y-2 p-4 transition-all hover:shadow-md' onClick={action.action}>
