...
const ToastViewport = React.forwardRef(({ className, ...props }, ref) => (<ToastPrimitives.Viewport ref={ref} className={cn('fixed left-1/2 top-4 z-[100] flex max-h-screen w-full max-w-[420px] -translate-x-1/2 flex-col p-4', className)} {...props}/>));
