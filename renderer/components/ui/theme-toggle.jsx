...
export function ThemeToggle() {
    ...
    return (<Button variant='ghost' size='sm' className='h-9 w-9 transition-all duration-200 hover:scale-105 hover:bg-accent/50' onClick={handleToggleTheme} aria-label={`Current theme: ${currentLabel}. Click to cycle through themes.`} title={`Current: ${currentLabel}. Click to cycle: Light → Dark → System`}>
