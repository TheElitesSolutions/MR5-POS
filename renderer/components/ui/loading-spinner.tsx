...
export function PageLoader({ text = 'Loading...' }: { text?: string }) {
  return (
    <div className='flex h-[300px] items-center justify-center duration-100 animate-in fade-in-0'>
...
export function FullPageLoader({ text = 'Loading...' }: { text?: string }) {
  return (
    <div className='flex min-h-screen items-center justify-center bg-gray-50 duration-100 animate-in fade-in-0 dark:bg-gray-900'>
...
export function NavigationLoader({ text }: { text: string }) {
  return (
    <div className='duration-50 fixed inset-0 z-50 flex items-center justify-center bg-white/95 backdrop-blur-sm animate-in fade-in-0 dark:bg-gray-900/95'>
      <div className='space-y-4 text-center'>
        <div className='relative'>
