...
import { Package, AlertTriangle, DollarSign, TrendingDown, Download, Printer, AlertCircle, } from 'lucide-react';
import { useReportsStore } from '@/stores/reportsStore';
import { useToast } from '@/hooks/use-toast';
const InventoryReports = () => {
    const { inventoryReport, fetchInventoryReport, exportInventoryReport, dateRange, isLoading, error } = useReportsStore();
    ...
    return (<div className='space-y-6'>
      ...
      <div className='flex justify-end space-x-2 print:hidden'>
        <Button variant='outline' size='sm' onClick={handleExport} disabled={isExporting} className='flex items-center space-x-2'>
      ...
      {/* Low Stock Alerts */}
      {inventoryReport.lowStockItems.length > 0 && (<Card>
          <CardHeader>
          ...
          <CardContent>
            <div className='overflow-x-auto'>
              <table className='w-full'>
                ...
                <tbody>
                  {inventoryReport.lowStockItems.map((item) => (<tr key={item.id} className='border-b hover:bg-gray-50 dark:hover:bg-gray-800'>
        ...
        <CardContent>
          <div className='overflow-x-auto'>
            <table className='w-full'>
              ...
              <tbody>
                {inventoryReport.currentStock.map((item) => (<tr key={item.id} className='border-b hover:bg-gray-50 dark:hover:bg-gray-800'>
                    <td className='p-3 font-medium'>{item.name}</td>
                    <td className='p-3 text-gray-600 dark:text-gray-400 hidden lg:table-cell'>
                      {item.category}
                    </td>
                    ...
                    <td className='p-3 text-center'>
                      <span className={`inline-block rounded-full px-2 py-1 text-xs font-medium ${item.status === 'out'
      ...
      {/* Stock Usage */}
      {inventoryReport.stockUsage.length > 0 && (<Card>
          <CardHeader>
            <CardTitle className='flex items-center space-x-2'>
          ...
          <CardContent>
            <div className='overflow-x-auto'>
              <table className='w-full'>
                ...
                <tbody>
                  {inventoryReport.stockUsage.map((item) => (<tr key={item.itemId} className='border-b hover:bg-gray-50 dark:hover:bg-gray-800'>
