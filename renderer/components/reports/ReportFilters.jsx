    ...
    return (<Popover open={isOpen} onOpenChange={setIsOpen}>
      <PopoverTrigger asChild>
        <Button variant='outline' size='sm' className='flex items-center space-x-2'>
          ...
          <span>Filters</span>
          {hasActiveFilters && (<div className='h-2 w-2 rounded-full bg-blue-500'></div>)}
        </Button>
      </PopoverTrigger>
      ...
      <PopoverContent className='w-80 p-4' align='end'>
        <div className='space-y-4'>
          ...
          <div className='flex items-center justify-between'>
            ...
            {hasActiveFilters && (<Button variant='ghost' size='sm' onClick={clearFilters} className='h-6 px-2 text-xs'>
          ...
          <div className='space-y-2'>
            ...
            <Input id='search' placeholder='Search by report name...' value={searchTerm} onChange={e => setSearchTerm(e.target.value)} className='h-8'/>
          </div>
          ...
          {/* Custom Date Range */}
          {selectedPreset === 'custom' && (<div className='space-y-2'>
              <Label className='text-xs font-medium'>Custom Date Range</Label>
              <div className='grid grid-cols-2 gap-2'>
                <Popover>
                  <PopoverTrigger asChild>
                    <Button variant='outline' className='h-8 justify-start px-3 text-xs'>
          ...
          <div className='flex space-x-2 pt-2'>
            <Button size='sm' className='h-8 flex-1' onClick={() => setIsOpen(false)}>
              Apply Filters
            </Button>
          </div>
        </div>
