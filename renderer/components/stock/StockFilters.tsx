...
import { StockFilters as StockFiltersType } from '@/hooks/useStockFilters';
...
interface StockFiltersProps {
  ...
  categories: string[];
  onUpdateFilter: <K extends keyof StockFiltersType>(
    key: K,
    value: StockFiltersType[K]
  ) => void;
  onResetFilters: () => void;
  resultCount: number;
}
        ...
        <div className='flex flex-col gap-3 sm:flex-row'>
          ...
          <div className='flex items-center space-x-2'>
            ...
            <Select
              ...
              onValueChange={value => onUpdateFilter('categoryFilter', value)}
            >
          ...
          <div className='flex items-center space-x-2'>
            ...
            <Select
              ...
              onValueChange={value =>
                onUpdateFilter('stockLevelFilter', value as any)
              }
            >
        ...
        <div className='flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between'>
          <div className='flex items-center space-x-2'>
            ...
            <Select
              ...
              onValueChange={value => onUpdateFilter('sortOrder', value as any)}
            >
