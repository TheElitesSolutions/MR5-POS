...
export function AddonGroupFormModal({ open, onClose, onSubmit, initialData, title, mode, }) {
          ...
          <Card>
            ...
            <CardContent className='space-y-3'>
              ...
              <div className='space-y-2'>
                ...
                <Input id='name' placeholder='e.g., Drink Sizes, Pizza Toppings' {...register('name')} className={errors.name ? 'border-destructive' : ''}/>
              ...
              <div className='space-y-2'>
                ...
                <Textarea id='description' placeholder='Brief description of this add-on group...' {...register('description')} className={errors.description ? 'border-destructive' : ''} rows={3}/>
            ...
            <CardContent className='space-y-3'>
              <div className='grid grid-cols-1 gap-3 md:grid-cols-2'>
                ...
                <div className='space-y-2'>
                  ...
                  <Input id='minSelections' type='number' min='0' max='20' {...register('minSelections', { valueAsNumber: true })} className={errors.minSelections ? 'border-destructive' : ''}/>
                  {errors.minSelections && (<p className='flex items-center gap-1 text-sm text-destructive'>
                      <AlertCircle className='h-3 w-3'/>
                ...
                <div className='space-y-2'>
                  ...
                  <Input id='maxSelections' type='number' min='1' max='50' placeholder='Unlimited' {...register('maxSelections', {
        valueAsNumber: true,
        setValueAs: value => value === '' ? null : parseInt(value),
    })} className={errors.maxSelections ? 'border-destructive' : ''}/>
                  {errors.maxSelections && (<p className='flex items-center gap-1 text-sm text-destructive'>
                      <AlertCircle className='h-3 w-3'/>
              ...
              {/* Validation Preview */}
              {(minSelections > 0 || maxSelections) && (<Alert>
