...
export const useMenuStore = create<MenuState>((set, get) => ({
  ...
  updateMenuItem: async (id, updates) => {
    ...
    try {
      ...
      console.log('🔍 STORE UPDATE - API Response data:', {
        id: apiItem.id,
        name: apiItem.name,
        rawIsVisibleOnWebsite: (apiItem as any).isVisibleOnWebsite,
        rawIsPrintableInKitchen: (apiItem as any).isPrintableInKitchen,
        typeOfIsVisibleOnWebsite: typeof (apiItem as any).isVisibleOnWebsite,
        fullApiItem: apiItem,
      });

      const updatedItem = convertToUIMenuItem(apiItem);

      console.log('🔍 STORE UPDATE - After convertToUIMenuItem:', {
        id: updatedItem.id,
        name: updatedItem.name,
        isVisibleOnWebsite: updatedItem.isVisibleOnWebsite,
        isPrintableInKitchen: updatedItem.isPrintableInKitchen,
      });
      ...
      console.log('🔍 STORE UPDATE - Updated item in finalMenuItems:', {
        found: finalMenuItems.find(i => i.id === id),
      });
