...
export class TransactionError extends Error {
    constructor(message, operations = [], cause) {
        super(message);
 ...
 */
export async function executeTransaction(operations, options = {}) {
    ...
    try {
        ...
        throw new TransactionError(`Transaction failed: ${error instanceof Error ? error.message : String(error)}`, [], // In a real implementation, we might track the operations that were attempted
 ...
 * @returns The result of the operations
 */
export async function executeMenuTransaction(operations, options = {}) {
