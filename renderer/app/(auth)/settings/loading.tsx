        ...
        <div className='space-y-4 text-center'>
          <div className='relative mx-auto'>
            <div className='border-3 flex h-14 w-14 items-center justify-center rounded-full border-gray-200 dark:border-gray-700'>
              <Settings className='loading-spin h-5 w-5 text-gray-600' />
            </div>
            <div className='border-3 loading-spin absolute left-0 top-0 h-14 w-14 rounded-full border-transparent border-t-gray-600'></div>
          </div>
