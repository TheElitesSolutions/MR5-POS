 ...
 */
export const getCrashReportsPath = () => {
 ...
 */
export const isPathAccessible = (filePath) => {
    try {
 ...
 */
export const cleanupTempFiles = (maxAge = 7 * 24 * 60 * 60 * 1000) => {
 ...
 */
export const getSafeWorkingDirectory = () => {
    try {
        return process.cwd();
    }
    catch {
