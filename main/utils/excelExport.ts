...
export async function exportSalesReportToExcel(
  ...
  try {
    enhancedLogger.info(
      `Exporting sales report to Excel: ${filepath}`,
    ...
    enhancedLogger.info(
      `Sales report exported successfully to ${filepath}`,
      LogCategory.BUSINESS,
      'ExcelExport'
    );
  } catch (error) {
...
export async function exportInventoryReportToExcel(
  ...
  try {
    enhancedLogger.info(
      `Exporting inventory report to Excel: ${filepath}`,
      LogCategory.BUSINESS,
      'ExcelExport'
    );
    ...
    enhancedLogger.info(
      `Inventory report exported successfully to ${filepath}`,
      LogCategory.BUSINESS,
      'ExcelExport'
    );
  } catch (error) {
 ...
 */
export async function exportProfitReportToExcel(
  ...
  try {
    enhancedLogger.info(
      `Exporting profit report to Excel: ${filepath}`,
      LogCategory.BUSINESS,
      'ExcelExport'
    );
    ...
    enhancedLogger.info(
      `Profit report exported successfully to ${filepath}`,
      LogCategory.BUSINESS,
      'ExcelExport'
    );
  } catch (error) {
...
export async function exportOrdersToExcel(
  ...
  try {
    enhancedLogger.info(
      `Exporting orders to Excel: ${filepath}`,
      LogCategory.BUSINESS,
      'ExcelExport'
    );
    ...
    enhancedLogger.info(
      `Orders exported successfully to ${filepath}`,
      LogCategory.BUSINESS,
      'ExcelExport'
    );
  } catch (error) {
