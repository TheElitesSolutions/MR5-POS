...
class ShortcutManager {
    ...
    registerShortcuts(mainWindow) {
        ...
        for (const [accelerator, description] of Array.from(this.shortcuts.entries())) {
            try {
                ...
                if (success) {
                    registeredCount++;
                    logDebug(`Registered shortcut: ${accelerator} (${description})`, "ShortcutManager");
                }
                else {
                    failedCount++;
                    logError(new Error(`Failed to register shortcut: ${accelerator}`), "ShortcutManager");
                }
            }
            catch (error) {
                failedCount++;
                logError(error, `ShortcutManager ${accelerator}`);
            }
        }
        logInfo(`Shortcuts registration complete: ${registeredCount} registered, ${failedCount} failed`, "ShortcutManager");
    }
    /**
     * Handle shortcut activation
     */
    handleShortcut(accelerator, description) {
        logDebug(`Shortcut activated: ${accelerator} (${description})`, "ShortcutManager");
    ...
    focusMainWindow() {
        ...
        try {
            ...
            logError(error, "ShortcutManager focusMainWindow");
        }
    }
    /**
    ...
    toggleFullscreen() {
        ...
        try {
            ...
            logDebug(`Fullscreen toggled: ${!isFullscreen ? "ON" : "OFF"}`, "ShortcutManager");
        }
        catch (error) {
            logError(error, "ShortcutManager toggleFullscreen");
        }
    }
    /**
    ...
    toggleDevTools() {
        ...
        try {
            ...
            logError(error, "ShortcutManager toggleDevTools");
        }
    }
    /**
    ...
    unregisterAllShortcuts() {
        try {
            ...
            logError(error, "ShortcutManager unregisterAll");
        }
    }
    /**
    ...
    unregisterShortcut(accelerator) {
        try {
            ...
            logError(error, `ShortcutManager unregister ${accelerator}`);
        }
    }
    /**
    ...
    isRegistered(accelerator) {
        try {
            ...
            logError(error, `ShortcutManager isRegistered ${accelerator}`);
            return false;
        }
    }
    /**
     ...
     */
    addShortcut(accelerator, description) {
        try {
            ...
            if (success) {
                ...
                logInfo(`Added shortcut: ${accelerator} (${description})`, "ShortcutManager");
                return true;
            }
            else {
                logError(new Error(`Failed to add shortcut: ${accelerator}`), "ShortcutManager");
                return false;
            }
        }
        catch (error) {
            logError(error, `ShortcutManager addShortcut ${accelerator}`);
            return false;
        }
    }
    /**
