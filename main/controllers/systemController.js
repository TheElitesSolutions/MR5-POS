...
export class SystemController extends BaseController {
    constructor() {
        super();
        this.appVersion = '2.3.0'; // Default version
    ...
    registerHandlers() {
        // Get system info
        this.registerHandler(SYSTEM_CHANNELS.GET_INFO, this.wrapHandler(async () => {
        ...
        // Check for updates
        this.registerHandler(SYSTEM_CHANNELS.CHECK_FOR_UPDATES, this.wrapHandler(async () => {
            return {
                version: '1.0.0',
        ...
        // Install update
        this.registerHandler(SYSTEM_CHANNELS.INSTALL_UPDATE, this.wrapHandler(async () => {
            logInfo('Update installation requested');
            return true;
        }));
        // Restart app
        this.registerHandler(SYSTEM_CHANNELS.RESTART_APP, this.wrapHandler(async () => {
            logInfo('App restart requested');
            return true;
        }));
        // Quit app
        this.registerHandler(SYSTEM_CHANNELS.QUIT_APP, this.wrapHandler(async () => {
            logInfo('App quit requested');
            return true;
        }));
        // Get database status
        this.registerHandler(SYSTEM_CHANNELS.GET_DATABASE_STATUS, this.wrapHandler(async () => {
        ...
        // Get logs
        this.registerHandler(SYSTEM_CHANNELS.GET_LOGS, this.wrapHandler(async (limit = 50) => {
