...
export class ServiceFactory {
     ...
     */
    static initializeServices(prisma) {
     ...
     */
    static registerMenuItemService(registry) {
     ...
     */
    static registerTableService(registry) {
     ...
     */
    static registerOrderService(registry) {
     ...
     */
    static registerInventoryService(registry) {
