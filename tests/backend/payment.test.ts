...
describe('Payment Processing', () => {
  ...
  describe('Partial Payments', () => {
    ...
    it('should prevent overpayment', () => {
      ...
      `).run(
        ...
        payments[0].createdAt.toISOString(),
  ...
  describe('Refund Processing', () => {
    ...
    beforeEach(() => {
      ...
      `).run(
        ...
        originalPayment.createdAt.toISOString(),
        originalPayment.updatedAt.toISOString()
      );
    });
    ...
    it('should process full refund', () => {
      ...
      `).run(
        ...
        refundPayment.notes,
        refundPayment.createdAt.toISOString(),
        refundPayment.updatedAt.toISOString()
      );
    ...
    it('should process partial refund', () => {
      ...
      `).run(
        ...
        partialRefund.amount,
        partialRefund.method,
        partialRefund.status,
        partialRefund.transactionId,
        partialRefund.notes,
        partialRefund.createdAt.toISOString(),
        partialRefund.updatedAt.toISOString()
      );
  ...
  describe('Payment Reconciliation', () => {
    it('should reconcile daily payments', () => {
      ...
      const cashReconciliation = reconciliation.find((r: any) => r.method === 'CASH');
      const cardReconciliation = reconciliation.find((r: any) => r.method === 'CARD');
  ...
  describe('Payment Integration', () => {
    ...
    it('should link payment to user who processed it', () => {
      ...
      `).run(
        paymentWithUser.id,
        paymentWithUser.orderId,
        paymentWithUser.amount,
        paymentWithUser.method,
        paymentWithUser.status,
        paymentWithUser.transactionId,
        paymentWithUser.notes,
        paymentWithUser.createdAt.toISOString(),
        paymentWithUser.updatedAt.toISOString()
      );
...
function validateRefundAmount(originalAmount: number, refundAmount: number): boolean {
