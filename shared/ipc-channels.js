 ...
 */
const createChannel = (namespace, action) => `${IPC_PREFIX}:${namespace}:${action}`;
/**
...
export const INVENTORY_CHANNELS = {
    ...
    GET_MENU_ITEM_INGREDIENTS: createChannel('inventory', 'get-menu-item-ingredients'),
    UPDATE_MENU_ITEM_INGREDIENTS: createChannel('inventory', 'update-menu-item-ingredients'),
    CHECK_STOCK_AVAILABILITY: createChannel('inventory', 'check-stock-availability'),
};
/**
 * Expense channels
 */
